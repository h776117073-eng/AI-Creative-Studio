...
import { VireonProfessionalWorkspace } from './VireonProfessionalWorkspace';
...
export function Workspace() {
  ...
  return <div className="h-screen w-screen overflow-hidden bg-[#080a0f]"><VireonProfessionalWorkspace projectId={projectId} /></div>;
}
