...
import { VireonMobileStudio } from './VireonMobileStudio';
...
export function Workspace() {
  ...
  return <div className="h-screen w-screen overflow-hidden bg-[#090b10]"><VireonMobileStudio projectId={projectId} /></div>;
}
